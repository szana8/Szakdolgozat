...
CREATE TABLE `fnd_user` (
  ...
  KEY `fullname_INDEX` (`first_name`,`last_name`),
  KEY `directory_INDEX` (`directory_id`),
  CONSTRAINT `directory_id_fk_u` FOREIGN KEY (`user_id`) REFERENCES `fnd_directories` (`directory_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `fnd_user`
--

LOCK TABLES `fnd_user` WRITE;
/*!40000 ALTER TABLE `fnd_user` DISABLE KEYS */;
INSERT INTO `fnd_user` VALUES (1,'admin','21232f297a57a5a743894a0e4a801fc3','Admin','','admin.localhost.hu',1,NULL,'0000-00-00 00:00:00',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
/*!40000 ALTER TABLE `fnd_user` ENABLE KEYS */;
UNLOCK TABLES;
